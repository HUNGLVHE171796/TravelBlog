...
public class AccountDAO extends DAO {
    ...
    public  List<Account> getAllAccount(){
        ...
        try {
            ...
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                comments.add(new Account(rs.getInt(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5)
                                  ,rs.getBoolean(6),rs.getString(7),RoleDAO.getRoleId(rs.getInt(8)), rs.getString(9)));
            }
            return comments;
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(d.getAllAccount());
    }
